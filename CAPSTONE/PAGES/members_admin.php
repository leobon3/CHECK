            ...
            <ul>
                ...
                <li>
                    ...
                    <div class="sub-menu">
                        ...
                        <a href="members_admin.php" class="sub-item" id="active">
            ...
            <div class="cardBox_3">
                <div class="card">
                    <div class="content-box">
                        ...
                        <a href="DIT_admin.php"><button class="btn">See members<div class="mem"></div></button></a>
                    </div>
                    <div class="date-box">
                ...
                <div class="card">
                    <div class="content-box">
                        ...
                        <a href="DCEA_admin.php"><button class="btn">See members<div class="mem"></div></button></a>
                    </div>
                    <div class="date-box">
                ...
                <div class="card">
                    <div class="content-box">
                        ...
                        <a href="DCEE_admin.php"><button class="btn">See members<div class="mem"></div></button></a>
                    </div>
                    <div class="date-box">
                ...
                <div class="card">
                    <div class="content-box">
                        ...
                        <a href="DAFE_admin.php"><button class="btn">See members<div class="mem"></div></button></a>
                    </div>
                    <div class="date-box">
                ...
                <div class="card">
                    <div class="content-box">
                        ...
                        <a href="DIET_admin.php"><button class="btn">See members<div class="mem"></div></button></a>
                    </div>
                    <div class="date-box">
