    ...
    <div class="web">
        <div class="navigation">
            <ul>
                ...
                <li>
                    <a href="profile_admin.php" class="active">
                        <span class="icon">
                    ...
                    <div class="card">
                        <div class="background">
                            <div class="profile">
                                ...
                                ?>
                                <div class="arrow">
                                    <svg xmlns="http://www.w3.org/2000/svg" height="30" width="30" viewBox="0 0 320 512"><path d="M310.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-192 192c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L242.7 256 73.4 86.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l192 192z"/></svg>
                                </div>
                            </div>	
                    ...
                    <div class="details">
                        <div class="table-container">
                            <table class="table" width="100%">
                                ...
                                <tbody>
                                <div class="center">
                                    <input type="checkbox" id="show" class="schedule-button">
                                    <label for="show" class="button2" id="schedule-button">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="50" viewBox="0 0 20 20" height="20" fill="none" class="svg-icon">
                                            <g stroke-width="1.5" stroke-linecap="round" stroke="#fc6a0394" fill="none">
                                    ...
                                    <div class="container">
                                        <form action="add_data_admin.php" method="post" id="myForm" onsubmit="handleSubmit(event)">
                                            <br>
                                            <h1 style="text-align: center; color: #2a2a2a;">Create Class Schedule</h1>
                                            <div class="data">
                                ...
                                <?php
                                    ...
                                    $sql = "SELECT start_time, end_time, date, subject, room, available_status FROM class_sched WHERE user_email = '$user_email'";
                                    $result = $conn->query($sql);
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                if ($schedule_date > $current_time) {
                                                    ...
                                                    $sqlUpdate = "UPDATE class_sched SET available_status = ? WHERE start_time = ?";
                                    ...
                                    $sql = "DELETE FROM class_sched WHERE date <= CURDATE() AND end_time < '$currentDateTime'";
