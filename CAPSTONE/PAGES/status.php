                    ...
                    <div class="popup" id="activityPopup">
                        <div class="popup-content">
                            <ul>
                                <?php
                                    if ($schedule_count > 0) {
                                        $query = "SELECT activity, start_time, date, file FROM table_sched WHERE user_email = '$user_email'";
                                        $result = mysqli_query($conn, $query);
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            // Display file link if a file path exists
                                            if ($filePath) {
                                                $fileName = basename($filePath); // Extract file name from the path

                                                echo ' - <a href="' . $filePath . '" download="' . $fileName . '">Download File</a>';
                                            }
